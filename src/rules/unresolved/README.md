...
The [no-external-barrel-reexports](../externalBarrelReexports/README.md) rule prevents barrel exports from third party and built-in modules, which mitigates this edge case.
